...
class Runner:
    """
    Runner: read the hyperparameters, create the environment and the RL model.
    """
    ...
    def is_bullet(env_id: str) -> bool:
        return "pybullet_envs" in Runner.entry_point(env_id)

    @staticmethod
    def is_robotics_env(env_id: str) -> bool:
        return "gym.envs.robotics" in Runner.entry_point(
            env_id
        ) or "panda_gym.envs" in Runner.entry_point(env_id)

    @staticmethod
    def is_panda_gym(env_id: str) -> bool:
        return "panda_gym.envs" in Runner.entry_point(env_id)
